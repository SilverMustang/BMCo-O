...
//			String[] columnNames = {"id","项目名称","类名称","方法名称","mcc","可能性"};
			String[] columnNames = {"id","projectName","className","methodName","mcc","possibility"};
			Object[][] tableValues = {};
...
//				JOptionPane.showMessageDialog(null, e, "错误", javax.swing.JOptionPane.ERROR_MESSAGE);
				JOptionPane.showMessageDialog(null, e, "error", javax.swing.JOptionPane.ERROR_MESSAGE);
			}
...
//			String[] columnNames = {"id","项目名称","类名称","loc","nof","nom","td","tw","ns","mc","可能性"};
			String[] columnNames = {"id","projectName","className","loc","nof","nom","td","tw","ns","mc","possibility"};
			Object[][] tableValues = {};
			DefaultTableModel tableModel = new DefaultTableModel(tableValues, columnNames);
