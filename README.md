...
***f~CS~Set***: Set of code-smell-co-occurrence impact factor;  
...
***Num_inEwt(CS~j~)***: sum Weight value of in-edges of CS~j~;  
***PriSet***: Detection priority set of all kinds of code smells;  
***F~CS~Set***: Initial state set of Code-smell-co-occurrence impactor factor set;  
